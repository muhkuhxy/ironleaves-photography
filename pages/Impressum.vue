<template>
  <div class="flex flex-col mx-auto max-w-prose px-8 pt-12 pb-4 text-bluegray">
    <h1>Impressum</h1>
    <address>
      Tamara Loeffen
      <br />Kluckweg 5a
    ...
    <h3 class="text-2xl">Datenschutz (allgemein)</h3>
    <p>
    ...
    <h3 class="text-2xl">2. Haftung f&#252;r Links</h3>
    <p>
    ...
    <h3 class="text-2xl">3. Urheberrecht</h3>
    <p>
    ...
    <p>
      ...
      <a class="underline cursor-pointer" target="_blank" href="http://www.hensche.de/impressum-generator.html">Impressum-Generators</a> von
      <a
        class="underline cursor-pointer"
        target="_blank"
        href="http://www.hensche.de/Rechtsanwalt_Arbeitsrecht_Koeln.html"
      >HENSCHE Rechtsanw&auml;lte, K&ouml;ln</a>
      erstellt.
    </p>
  </div>
</template>
