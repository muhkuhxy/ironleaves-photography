      ...
      <ol class="root mt-8">
        <li class="before:font-playfair">
          ...
          <ol>
            ...
            <li>
              ”Lichtbilder” im Sinne dieser AGB sind alle vom Fotografen hergestellten Produkte, gleich in welcher Form oder Medium sie erstellt wurden oder vorliegen (Negative, Dia-Positive, Papierbilder, Still-Videos, elektronische Stehbilder in digitaler Form, Videos, usw.).
            </li>
          </ol>
        </li>
        <li class="before:font-playfair">
          ...
          <ol>
            ...
            <li>
              Für den Fall, dass Ironleaves Photography einen Kostenvoranschlag erstellt, ist zu beachten, dass es sich dabei um eine unverbindliche Kostenschätzung handelt, die aufgrund der Informationen und Wünsche des Kunden erstellt wurde. Erst nach Ablauf des Shootings kann der tatsächlich angefallene Aufwand bestimmt und berechnet werden.
            </li>
            <li>
              Längerfristig vereinbarte Termine bedürfen zur Terminfreihaltung einer Vorauszahlung von 30% des geschätzten Auftragswertes. Der Betrag ist innerhalb von 14 Tagen nach Auftragserteilung zahlbar. Diese Vorauszahlung wird bei einem durch den Auftraggeber verschuldeten Nichtzustandekommen des Vertrages einbehalten.
            </li>
            <li>
              Verbal oder online vereinbarte Termine sind erst dann fixiert und verbindlich gebucht, wenn eine Anzahlung geleistet wurde.
            </li>
          </ol>
        </li>
        <li class="before:font-playfair">
          ...
          <ol>
            <li>
              Vertragsgegenstand ist die Aufnahme und Bearbeitung von Lichtbildern durch Ironleaves Photography zu einem mit dem Auftraggeber vereinbarten Zeitpunkt sowie die Übertragung von Nutzungsrechten an diesen Bildern.
            </li>
            <li>
              Ironleaves Photography fotografiert an dem vom Auftraggeber benannten Ort und Zeit gemäß der zwischen den Parteien getroffenen Abrede.
            </li>
            <li>
            ...
            <li>
              Die Auftraggeber haben dafür Sorge zu tragen, dass Ironleaves Photography alle für die Ausführung des Auftrags erforderlichen Informationen rechtzeitig vorliegen.
            </li>
            <li>
              Soweit zwischen den Parteien nichts Abweichendes vereinbart wurde, ist bei mehreren Personen als Auftraggeber jede dieser Personen dazu berechtigt und bevollmächtigt, für die Abwicklung des Vertragsverhältnisses mit Ironleaves Photography notwendige Willenserklärungen im Namen aller Auftraggeber anzunehmen und abzugeben.
            </li>
            <li>
        ...
        <li class="before:font-playfair">
          ...
          <ol>
            <li>
              Sobald der Kunde eine schriftliche Bestätigung von Ironleaves Photography erhalten hat, hält sich Ironleaves Photography diesen Termin für den Kunden frei und kann für diesen Tag daher keine weiteren Angebote annehmen.
            </li>
            <li>
            ...
            <li>
              Die Stornierung des Shootings ist bis zu 90 Tage vor dem vereinbarten Termin ohne weitere Kosten möglich. Maßgeblicher Zeitpunkt für die wirksame Erklärung des Rücktritts ist der Eingang der Rücktrittserklärung in Textform bei Ironleaves Photography. Das Verbrauchern zustehende Widerrufsrecht sowie eventuelle weitere gesetzliche Rechte, die Verbraucher dazu berechtigen, sich vom Vertrag mit Ironleaves Photography zu lösen, bleiben unberührt. Die Reservierungsgebühr wird wie oben beschrieben einbehalten.
            </li>
            <li>
              Die Fotografin ist berechtigt, nachfolgende Beträge in Rechnung zu stellen, wenn es aus Gründen, die von der Fotografin nicht zu verantworten sind, nicht zur Durchführung des Auftrages kommt:
              <ul>
                <li>bis 60 Tage vor Auftragsbeginn: 50 % der vereinbarten Gesamtsumme</li>
                <li>bis 40 Tage vor Auftragsbeginn: 75 % der vereinbarten Gesamtsumme</li>
                <li>bis 20 Tage vor Auftragsbeginn: 100 % der vereinbarten Gesamtsumme</li>
              </ul>
              Dies gilt auch dann, wenn noch keine vollständige oder teilweise Zahlung entrichtet ist.
            </li>
            <li>
              Erscheint der Auftraggeber nicht zum Termin ohne fristgemäße Absage, wird ein Ausfallhonorar in Höhe von 100% fällig.
            </li>
            <li>
              Alle bis dahin aufgewendeten Nebenkosten (z.B. für die Reservierung des Hotelzimmers) sind vom Kunden zu tragen und können nicht auf Ironleaves Photography übertragen werden.
            </li>
            <li>
            ...
            <li>
              Durch eine Stornierung entfällt der Anspruch auf den reservierten Termin. Ironleaves Photography wird im Rahmen des üblichen Geschäftsgangs versuchen, nach einem Rücktritt der Auftraggeber für den Buchungstermin andere Aufträge zu bekommen.
            </li>
          </ol>
        </li>
        <li class="before:font-playfair">
          ...
          <ol>
            <li>
              Der Kunde übernimmt es als eine vertragliche Hauptleistungspflicht, dafür zu sorgen,
dass notwendige Einwilligungen und/oder Genehmigungen (z.B. aus dem Persönlichkeitsrecht
oder dem Eigentumsrecht Dritter) vorliegen, falls durch die fotografische Tätigkeit in Rechte
Dritter eingegriffen wird.
            </li>
            <li>
              Wenn auf den Fotografien außer dem Auftraggeber noch andere Personen abgebildet sein
sollen, zum Beispiel die Teilnehmer einer Veranstaltung oder die Gäste einer Hochzeit, sind die
Auftraggeber dazu verpflichtet, sicherzustellen, dass sämtliche dieser Personen bzw. deren
gesetzliche Vertreter zugestimmt haben, von Ironleaves Photography fotografiert zu werden. Der
Auftraggeber wird diese Personen und unter Hinweis auf die Datenschutzerklärung von Ironleaves Photography darüber informieren, dass Ironleaves Photography die Veranstaltung oder Hochzeit
fotografiert.
              <ol>
                <li>
                ...
                <li>
                  Falls die Auftraggeber nicht nachweisen können, dass eine entsprechende Einwilligung eingeholt wurde, und auch nicht glaubhaft machen können, dass eine Einwilligung nicht
    notwendig ist, ist Ironleaves Photography berechtigt, die weitere Ausführung des Auftrages bezüglich
    dieser Personen zu verweigern. Die Vergütung von Ironleaves Photography wird deshalb nicht reduziert.
                </li>
              </ol>
            </li>
            <li>
              Falls neben den Einwilligungen der außer dem Auftraggeber anwesenden Personen noch
weitere Genehmigungen zum Fotografieren erforderlich sind, insbesondere bei Fotografien
innerhalb von Gebäuden, ist der Auftraggeber verpflichtet, die entsprechenden Genehmigungen
einzuholen.
              <ol>
                <li>
                  Ironleaves Photography ist nicht dazu verpflichtet zu prüfen, ob solche Genehmigungen erforderlich sind oder vorliegen. Ironleaves Photography kann aber jederzeit vom Auftraggeber verlangen, nachzuweisen, dass die entsprechenden Genehmigungen eingeholt worden sind.
                </li>
                <li>
                  Falls die Auftraggeber nicht nachweisen können, dass die entsprechenden Genehmigungen
eingeholt wurden, ist Ironleaves Photography berechtigt, die weitere Ausführung des Auftrages insoweit zu verweigern, als die fehlenden Genehmigungen für eine rechtmäßige Durchführung des
Auftrages notwendig gewesen wären. Die Vergütung von Ironleaves Photography wird deshalb nicht
reduziert.
                </li>
              </ol>
            </li>
            <li>
              Wenn nach den vorstehenden Ziffern 5.1, 5.2 und/oder 5.3 notwendige Einwilligungen und
Genehmigungen nicht vorlagen, wird der Auftraggeber Ironleaves Photography von allen Ansprüchen
Dritter, die aufgrund der Anfertigung und/oder Verwertung der Fotografien gegen Ironleaves Photography erhoben werden, freistellen und auch die Kosten der erforderlichen Rechtsverteidigung tragen.
            </li>
          </ol>
        </li>
        <li class="before:font-playfair">
          ...
          <ol>
            <li>
              Bei Fotoaufnahmen im Rahmen von Veranstaltungen weist Ironleaves Photography darauf hin, dass der Kunde (Hochzeitspaar, Veranstalter etc.) dafür Sorge zu tragen hat, dass die teilnehmenden Gäste darüber informiert werden, dass bei der Veranstaltung fotografiert bzw. gefilmt wird. Sollten Gäste dieses nicht wünschen, müssen sie dieses dem Veranstalter mitteilen.
            </li>
            <li>
              Der Kunde (Veranstalter) hat Ironleaves Photography darüber zu informieren und dafür Sorge zu tragen, dass diese Personen bei Gruppenbildern etc. nicht zu sehen sind.
            </li>
            <li>
              Unterlässt der Kunde die vorbeschriebene Information seiner Gäste stellt der Kunde damit Ironleaves Photography von sämtlichen Ansprüchen frei, die Dritte bzgl. einer Verletzung ihres Persönlichkeitsrechts etc. geltend machen.
            </li>
            <li>
              Darüber hinaus hat der Kunde vorab zu klären, ob in/an der jeweiligen Lokalität (Hotel, Gastraum, Kirche, Park etc.) fotografiert bzw. gefilmt werden darf. Er hat hier das Einverständnis des Eigentümers einzuholen.
            </li>
            <li>
              Versäumt der Kunde diese Nachfrage und untersagt der Eigentümer bzw. ein berechtigter Dritter die Fotoaufnahmen durch Ironleaves Photography, hat der Kunde sämtliches vereinbartes Honorar zu tragen.
            </li>
            <li>
              Während des Fotoshootings (Paar-Fotoshootings/ Hochzeits-Fotoshooting) etc. ist es allen anderen Personen – außer Ironleaves Photography untersagt zu fotografieren.
            </li>
            <li>
              Unwesentliche Änderungen im Shooting-Ablauf oder eine zumutbare Verlegung des Shooting-Ortes berechtigen nicht zur Preisminderung oder zum Rücktritt vom Vertrag.
            </li>
            <li>
              Ironleaves Photography übernimmt keine Haftung für mitgebrachte Wertgegenstände.
            </li>
            <li>
        ...
        <li class="before:font-playfair">
          ...
          <ol>
            ...
            <li>
              Die Auswahl der ausgehändigten, bearbeiteten Bilder obliegt der Auftragnehmerin. Bis zur Übergabe an den Auftraggeber werden weitere Rohbilder bewahrt.
            </li>
            <li>
              Zusätzliche Bildbearbeitungen von Lichtbildern (Retuschen, Farbänderungen, etc.) stellen einen Mehraufwand dar und werden nach Vereinbarung entsprechend in Rechnung gestellt.
            </li>
            <li>
              Die Originaldateien im RAW-Format verbleiben bei der Fotografin. Sie werden in keinem Fall an den Auftraggeber ausgehändigt.
            </li>
            <li>
        ...
        <li class="before:font-playfair">
          ...
          <ol>
            <li>
              Übergibt oder sendet der Kunde eigene Bilder zur Weiterbearbeitung oder Produktherstellung zu, hat Ironleaves Photography ein Urheberrecht am erstellten Produkt, das Urheberrecht am Bild liegt beim Kunden.
            </li>
            <li>
              Der Kunde erklärt, bei Übersendung der Bilder der Urheber der Bilder zu sein. Sollten Sie dies nicht sein, haften Sie uns gegenüber, dass Sie die Bilder uneingeschränkt im Rahmen der obigen Nutzungsrechte nutzen dürfen. Insoweit stellen Sie Ironleaves Photography von jeglichen Ansprüchen Dritter frei.
            </li>
            <li>
            ...
            <li>
              Eine Haftung von Ironleaves Photography für die seitens des Kunden zur Verfügung gestellten Bilder/Videos ist ausgeschlossen. Der Kunde stellt Ironleaves Photography von jeglicher Haftung, einschließlich der Kosten notwendiger Rechtsverteidigung gegenüber Dritten, für derartige Inhalte frei.
            </li>
            <li>
              Sind Leistungen von Ironleaves Photography teilweise oder insgesamt aufgrund der seitens des Kunden beigebrachten Bilder nicht verwertbar, bleibt der Anspruch von Ironleaves Photography auf Vergütung unberührt.
            </li>
            <li>
        ...
        <li class="before:font-playfair">
          ...
          <ol>
            <li>
              Ironleaves Photography steht das Urheberrecht an sämtlichen erstellten Foto- und Videoaufnahmen nach dem Urheberrechtsgesetz zu.
            </li>
            <li>
              Die Nutzungsrechte gehen erst über nach voll­ständi­ger Bezahlung des Hon­o­rars an den Fotografen. Der Auf­tragge­ber hat kein Recht, das Licht­bild zu vervielfälti­gen und zu ver­bre­iten, wenn nicht die entsprechen­den Nutzungsrechte über­tra­gen wor­den sind.
            </li>
            <li>
              Überträgt der Fotograf Nutzungsrechte an seinen Werken, ist – sofern nicht aus­drück­lich etwas anderes vere­in­bart wurde – jew­eils nur das ein­fache Nutzungsrecht über­tra­gen. Der Kunde erhält eine einfache, nicht übertragbare, zeitlich und räumlich unbeschränkte Lizenz die für ihn angefertigten Bilder privat zu nutzen. Eine Vervielfältigung, Bearbeitung, Manipulation, Verkauf und Verbreitung der Fotoaufnahmen ist nicht gestattet. Die Übertragung der dem Kunden eingeräumten Rechte an Dritte oder eine Nutzung für andere als die vertraglich vereinbarten Zwecke bedarf im Einzelfall der gesonderten schriftlichen Zustimmung durch Ironleaves Photography.
            </li>
            <li>
              Möchte der Kunde die Fotoaufnahmen kommerziell nutzen, z.B. für seine Unternehmenswebseite, zu Werbezwecken, auf Flyern und in Social Media, muss dieses gesondert im Rahmen einer Lizenzvereinbarung vereinbart werden. Dort wird angegeben, für welche Zwecke die Nutzungsrechte übertragen werden.
            </li>
            <li>
            ...
            <li>
              Wünscht der Kunde nach Abschluss des Auftrages ein erweitertes Nutzungsrecht, ist Ironleaves Photography zu informieren. Für die Erweiterung fallen Nutzungsgebühren an, die je nach Umfang des Nutzungsrechtes zu berechnen sind.
            </li>
            <li>
              Bei Ironleaves Photography verbleibt das Eigentum an den Negativen, den Rohdaten (RAW-Dateien) der Bilder, sowie digitalen Datenträgern, die für die Durchführung des Kundenauftrages erstellt worden sind.
            </li>
            <li>
              Auf Anfrage durch Ironleaves Photography ist der Kunde verpflichtet, Ironleaves Photography Auskunft über den Umfang der Nutzung der Leistungen zu erteilen.
            </li>
            <li>
        ...
        <li class="before:font-playfair">
          ...
          <ol>
            <li>
              Für eine unterlassene oder falsche Urheberkennzeichnung oder eine falsche Platzierung der Kennzeichnung ist der Kunde verpflichtet, einen Aufschlag i.H.v. 100 % auf das vereinbarte Nutzungsentgelt bzw. ein übliches Nutzungsentgelt an Ironleaves Photography zu zahlen.
            </li>
            <li>
        ...
        <li class="before:font-playfair">
          ...
          <ol>
            ...
            <li>
              Ironleaves Photography ist berechtigt, nach Auftragserteilung eine Abschlagszahlung über 30% der vereinbarten oder zu erwartenden Vergütung in Rechnung zu stellen. Im Übrigen ist Ironleaves Photography berechtigt, dem Kunden Abschlagszahlungen über bereits erbrachte Teilleistungen in Rechnung zu stellen.
            </li>
            <li>
              Die Rechnungsstellung durch Ironleaves Photography erfolgt nach Erbringung der Teil- bzw. Gesamtleistung. Der Kunde erklärt sich damit einverstanden, Rechnungen auch per E-Mail zu erhalten; in diesem Fall entfällt der Postversand dafür.
            </li>
            <li>
              Bis zur vollständigen Bezahlung des Auftrages behält sich Ironleaves Photography sämtliche Eigentumsrechte und Nutzungsrechte an den Arbeitsergebnissen, dem Kunden bereits ausgehändigter Produkten oder sonstiger Leistungen vor.
            </li>
            <li>
              Rechnungen sind innerhalb von 14 Tagen ohne Abzug zur Zahlung fällig. Nach Ablauf der vorgenannten Frist ist Ironleaves Photography, unbeschadet sonstiger Ansprüche berechtigt, Verzugszinsen in Höhe des jeweils einschlägigen Absatzes des § 288 BGB zu beanspruchen.
            </li>
            <li>
...
vereinbarten Stunden- oder Tagessatz.
        ...
        <li class="before:font-playfair">
          ...
          <ol>
            <li>
              Ironleaves Photography haftet dem Kunden, außer in Fällen der Verletzung des Körpers, des Lebens oder der Gesundheit und bei Verletzung von Hauptleistungspflichten, auf Schadensersatz nur bei Vorsatz oder grober Fahrlässigkeit.
            </li>
            <li>
              Im Übrigen ist die Haftung von Ironleaves Photography auf vertragstypische und vorhersehbare Schäden begrenzt. Eine Erstattung des vorhersehbaren, typischerweise entstehenden Schadens ist zudem auf höchstens den 5 – fachen Betrag des Auftrages begrenzt. Die Haftung für mittelbare Schäden wird ausgeschlossen. Insbesondere besteht keinerlei Haftung für höhere Gewalt (plötzliche Erkrankungen, Flugausfall, Verkehrsunfall, etc.) auf Seiten der Auftragnehmerin oder ihrer Erfüllungsgehilfen oder gesetzlichen Vertreter.
            </li>
            <li>
              Ironleaves Photography haftet nicht für die Verletzung von Rechten abgebildeter Personen oder Sachen – es sei denn es liegt ein entsprechender Property Release vor.
            </li>
            <li>
              Ironleaves Photography haftet nicht für Schadensersatzansprüche Dritter gegen den Kunden, die durch den Zusammenhang von durch Ironleaves Photography erstellten Bilder und Text entstehen. Die Darstellung von Bildern in einem bestimmten Kontext obliegt alleine dem Kunden.
            </li>
            <li>
              Wird Ironleaves Photography von Dritten aufgrund bearbeiteter Bilder, die der Kunde beigebracht hat, auf Unterlassung oder Schadensersatz in Anspruch genommen, stellt der Kunde Ironleaves Photography von der Haftung frei und erstattet Ironleaves Photography sämtliche zur Rechtsverteidigung entstandenen Aufwendungen. Der Vergütungsanspruch von Ironleaves Photography bleibt hiervon unberührt.
            </li>
            <li>
              Die Auftragnehmerin haftet nicht für den Verlust von gespeicherten und digitalen Daten, sofern sie es nicht durch grobe Fahrlässigkeit oder Vorsatz zu verantworten hat.
            </li>
            <li>
              Der Fotograf verwahrt die Daten sorgfältig. Er ist berechtigt, aber nicht verpflichtet, von ihm aufbewahrte Daten nach drei Jahren seit Beendigung des Auftrags zu vernichten. Für Beschädigung und Vernichtung der Negative haftet er nur bei Vorsatz und grober Fahrlässigkeit bis zum Materialwert.
            </li>
            <li>
            ...
            <li>
              Der Fotograf haftet für Lichtbeständigkeit und Dauerhaftigkeit eigens gedruckter Lichtbilder nur im Rahmen der Garantieleistungen der Hersteller des Fotomaterials.
            </li>
            <li>
              Die Fotografin ist berechtigt, Fremdlabore, Fotobuchhersteller oder Produzenten von
Hochzeitsalben, Druckereien etc. zu beauftragen. Die Fotografin ist weiterhin berechtigt, die
Aufträge mittels eigenen Personals oder mittels Fremdleistung zu erbringen. Die Fotografin verpflichtet sich, Erfüllungsgehilfen sorgfältig auszusuchen und anzuleiten. Darüber hinaus haftet sie für ihre Erfüllungsgehilfen nicht. Sie haftet nur für eigenes Verschulden und nur für vorsätzliches oder grob fahrlässiges Verhalten. Über den Materialwert hinausgehender Schadensersatz ist ausgeschlossen.
            </li>
            <li>
              Für den Fall, dass es erforderlich ist Dritte (z.B. Stylisten, Make-up-Artist, Assistenten) mit hinzuzuziehen, ist Ironleaves Photography berechtigt, diese Dritten im Auftrag und im Namen des Kunden und auf dessen Rechnung zu beauftragen. In diesem Fall kommt KEIN Vertrag zwischen Ironleaves Photography und dem Dritten zustande.
            </li>
            <li>
...
resultierenden Schäden, Verluste oder Folgen übernommen werden. Sollte Ironleaves Photography Aufgrund von Umständen die höherer Gewalt gleichstehen (s.o) den Auftrag nicht eigenständig durchführen können so wird Ironleaves Photography einen geeigneten Ersatz suchen und vorschlagen. Es obliegt dem Auftraggeber diesen Vorschlag anzunehmen. Die Vergütung des Ersatzfotografen, sofern über Ironleaves Photography vermittelt wird von Ironleaves Photography getragen. Der Vertrag zwischen Auftraggeber und Ironleaves Photography bleibt hiervon unberührt. Ironleaves Photography ist bemüht einen Fotografen zu beauftragen, sollte es Ironleaves Photography aber nicht möglich sein besteht kein Anspruch auf Preisnachlass. Der Auftraggeber ist in diesem Fall berechtigt den Ersatz von Ironleaves Photography abzulehnen und erhält die Anzahlung abzüglich der bereits geleisteten Arbeit zurück.
        ...
        <li class="before:font-playfair">
          ...
          <ol>
            <li>
              Die Fotografin stellt dem Kunden innerhalb von 6 – 8 Wochen die ausgewählten, bearbeiteten Bilder zur Verfügung. Gesonderte Liefertermine für Fotos sind nur dann verbindlich, wenn sie schriftlich von der Fotografin bestätigt worden sind. Verzögerun­gen durch höhere Gewalt, Betriebsstörungen, von Verzögerun­gen seit­ens des Labors oder dessen Trans­port­firma etc. stellen keinen Reklamationsgrund dar. Die Fotografin haftet für Fristüberschreitungen nur bei Vorsatz und grober Fahrlässigkeit.
            </li>
            <li>
              Die Versendung von Filmen, Lichtbildern und Vorlagen erfolgt auf Kosten und Gefahr des Auftraggebers. Für Schäden, die durch das Übertragen von gelieferten Daten in einem Computer entstehen, leistet die Fotografin keinen Ersatz.
            </li>
            <li>
              Ironleaves Photography haftet nicht für die Verfügbarkeit oder korrekte Funktion von Infrastrukturen, Software oder Übertragungswegen des Internets, die nicht im Verantwortungsbereich von Ironleaves Photography liegen.
            </li>
            <li>
              Für Verträge über Lieferung von Waren als Zusatzleistungen (zum Beispiel Abzüge von Fotografien auf Papier oder Leinwand) besteht kein Widerrufsrecht, da es sich um Verträge zur Lieferung von Waren handelt, die nicht vorgefertigt sind und für deren Herstellung eine individuelle Auswahl oder Bestimmung durch den Verbraucher maßgeblich ist und die eindeutig auf die persönlichen Bedürfnisse des Verbrauchers zugeschnitten sind.
            </li>
            <li>
              Die Bilder werden, sofern nicht anders vereinbart, in voller Auflösung und nachbearbeitet als JPG Datei ausgeliefert. Medium und Art der Auslieferung ergeben sich aus der vertraglichen Vereinbarung.
            </li>
          </ol>
        </li>
        <li class="before:font-playfair">
...
Ironleaves Photography geregelt, die auf der Website abgerufen werden kann.
        ...
        <li class="before:font-playfair">
          ...
          <ol>
            ...
            <li>
              Ironleaves Photography nimmt nicht an einem Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teil.
            </li>
            <li>
              Sollten einzelne Bestimmungen dieser AGB unrichtig, unwirksam oder anfechtbar sein oder werden, sind sie so auszulegen bzw. zu ergänzen, dass der beabsichtigte wirtschaftliche Zweck möglichst genau erreicht wird; die übrigen Bestimmungen bleiben davon unberührt. Sinngemäß gilt dies auch für ergänzungsbedürftige Lücken.
            </li>
          </ol>
        </li>
      </ol>
