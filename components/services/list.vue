  ...
  <SectionParent class="text-bluegray">
    <SectionContent>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-y-8 gap-x-20">
        <div class="space-y-4">
          <h2>Persönliches Vorgespräch</h2>
          <p>
        ...
        <div class="space-y-4">
          <h2>Photo-Art, Papeterie, Album etc.</h2>
          <p>
        ...
        <div class="space-y-4">
          <h2>Aufwendige Fotoretuschen</h2>
          <p>
