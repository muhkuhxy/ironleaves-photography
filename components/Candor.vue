<template>
  <SectionParent class="bg-bluegray text-white relative">
    ...
    <IlFigure class="lg:absolute lg:w-50% 2xl:w-40% lg:inset-y-0 lg:right-0">
      ...
      <IlFigureCaption class="lg:text-right lg:top-0 lg:pt-8 lg:px-0 transform lg:-translate-x-40% lg:w-max">
      <!-- <IlFigureCaption class="lg:top-0 lg:mt-8 lg:left-0 lg:w-max lg:-ml-40%"> -->
    ...
    <SectionContent class="">
      <div class="lg:py-32 lg:mr-55% xl:mr-66%">
